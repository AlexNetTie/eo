...
```text
to-java.xsl              54458  34.43%
classes.xsl              46127  29.17%
set-locators.xsl         13111  8.29%
set-original-names.xsl   9317   5.89%
attrs.xsl                8457   5.35%
data.xsl                 8085   5.11%
anonymous-to-nested.xsl  6541   4.14%
tests.xsl                6046   3.82%
package.xsl              6015   3.80%
```

The results were calculated in [this GHA job][benchmark-gha]
on 2026-04-30 at 17:20,
on Linux with 4 CPUs.
The total is 158157 milliseconds.
...
[benchmark-gha]: https://github.com/AlexNetTie/eo/actions/runs/25179003702
